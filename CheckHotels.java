...
public class CheckHotels extends JFrame implements Runnable {
    ...
    public void run() {
        String[] text = new String[]{"The Oberoi Hotel", "mperial Golf Hotel", "Coast Hotels", "The Leela Bhartiya", "The Leela Kovalam, A Raviz Hotel", "Rambagh Palace", "Kaldan Samudhra Palace", "Taj Connemara, Chennai", "Taj Krishna, Hyderabad", "Chandys Windy Woods"};
        try {
            for (int i = 0; i <= 9; i++) {
